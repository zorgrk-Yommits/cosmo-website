  ...
  return (
    <div className="terminal-container terminal-theme-scope">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 pt-24 pb-12">
        ...
        <p className="text-ink-0 text-lg leading-relaxed mb-4 font-mono max-w-2xl">
        ...
        <p className="text-ink-1 text-base leading-relaxed mb-8 font-sans max-w-2xl">
      ...
      <section id="journey" className="relative z-10 max-w-5xl mx-auto px-6 py-10 scroll-mt-24">
        <h2 className="font-mono text-xl text-ink-0 mb-6">
        ...
        <ol className="space-y-4">
          {JOURNEY.map((s) => (
            <li
              key={s.step}
              className="rounded-xl border border-line-base bg-surface-1 p-5 flex gap-4"
            >
              <span className="font-mono text-phase-active text-sm pt-0.5">{s.step}</span>
              <div>
                <h3 className="font-mono text-sm text-ink-0 mb-1">{s.title}</h3>
                <p className="font-sans text-sm leading-relaxed text-ink-1">{s.body}</p>
                {s.showMinBond && (
                  <p className="mt-2 font-mono text-[11px] text-ink-1">
                    Required minimum deposit right now:{' '}
                    <span className="text-phase-active">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        <div className="flex items-center gap-2 mb-4">
          <ShieldCheck className="h-5 w-5 text-phase-active" />
          <h2 className="font-mono text-xl text-ink-0">
            Your security deposit — self-service, live parameters
          </h2>
        </div>
        <div className="rounded-xl border border-line-base bg-surface-1 p-6 max-w-3xl">
          ...
          <div className="mb-4 flex flex-wrap gap-3">
            ...
            <Link
              href="/wcosmo/"
              className="inline-flex items-center gap-2 rounded-lg border border-line-base bg-surface-1 px-4 py-2 font-mono text-xs text-ink-1 transition-all hover:border-line-strong hover:text-white"
            >
              What is wCOSMO?
              <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          ...
          <table className="w-full">
            <tbody>
              {PARAMS.map((p) => (
                <tr key={p.label} className="border-t border-line-subtle">
                  <td className="py-1.5 pr-3 font-mono text-[11px] text-ink-2 align-top">{p.label}</td>
                  <td className="py-1.5 font-mono text-[11px] text-ink-1">{p.value}</td>
                </tr>
              ))}
            </tbody>
          </table>
          <p className="mt-3 font-mono text-[10px] leading-relaxed text-ink-2">
      ...
      <section id="proof" className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        <h2 className="font-mono text-xl text-ink-0 mb-2">
          Proof — real jobs, settled on mainnet
        </h2>
        <p className="font-sans text-sm leading-relaxed text-ink-1 max-w-3xl mb-4">
        ...
        <h3 className="font-mono text-base text-ink-0 mt-4 mb-2">
        ...
        <p className="font-mono text-[11px] leading-relaxed text-ink-2 max-w-3xl mb-4">
        ...
        <div className="rounded-xl border border-line-base bg-surface-1 overflow-hidden mb-8">
          {patch001.legs.map((leg, i) => (
            <div
              key={leg.name}
              className={`flex flex-col md:flex-row md:items-center gap-2 md:gap-4 px-5 py-3 ${i > 0 ? 'border-t border-line-subtle' : ''}`}
            >
              <span className="font-mono text-phase-active text-xs w-6 shrink-0">{i + 1}</span>
              <span className="font-mono text-ink-0 text-xs w-48 shrink-0">{leg.name}</span>
              <span className="font-sans text-ink-1 text-xs leading-relaxed flex-1">{leg.detail}</span>
              <a
                href={txUrl(leg.hash)}
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-[11px] text-phase-active hover:text-phase-active shrink-0"
              >
                {short(leg.hash)} ↗
              </a>
            </div>
        ...
        <p className="font-sans text-sm leading-relaxed text-ink-1 max-w-3xl mb-4">
          ...
          {' '}<span className="font-mono text-ink-1">attest001.py verify --job-id 1</span>.
        </p>
        <p className="font-mono text-[11px] leading-relaxed text-ink-2 max-w-3xl mb-4">
        ...
        <div className="rounded-xl border border-line-base bg-surface-1 overflow-hidden">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="rounded-xl border border-line-base bg-surface-1 p-6 max-w-3xl">
          <div className="flex items-center gap-2 mb-3">
            <FileText className="h-4 w-4 text-phase-active" />
            <h3 className="font-mono text-sm text-ink-0">Bring a workload</h3>
          </div>
          <p className="font-sans text-sm leading-relaxed text-ink-1 mb-3">
          ...
          <ul className="space-y-1.5 font-mono text-[12px] text-ink-1">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        <h2 className="font-mono text-xl text-ink-0 mb-2">Pay in the asset that fits</h2>
        <p className="font-sans text-sm leading-relaxed text-ink-1 mb-6 max-w-3xl">
          Since 2026-07-11 the market accepts three payment assets. The rule is simple:{' '}
          <span className="text-ink-0">payment assets pay for the work — the wCOSMO security
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          <div className="rounded-xl border border-line-base bg-surface-1 p-5">
            <h3 className="font-mono text-sm text-ink-0 mb-2">wCOSMO</h3>
          ...
          <div className="rounded-xl border border-line-base bg-surface-1 p-5">
            <h3 className="font-mono text-sm text-ink-0 mb-2">CASH</h3>
            <p className="font-sans text-sm leading-relaxed text-ink-1">
          ...
          <div className="rounded-xl border border-line-base bg-surface-1 p-5">
            <h3 className="font-mono text-sm text-ink-0 mb-2">SUPRA</h3>
            <p className="font-sans text-sm leading-relaxed text-ink-1">
        ...
        <div className="rounded-xl border border-line-base bg-surface-1 p-5 mb-6">
          <h3 className="font-mono text-sm text-ink-0 mb-2">Pay straight from your wallet</h3>
          <p className="font-sans text-sm leading-relaxed text-ink-1 mb-3">
            Buyers call{' '}
            <code className="font-mono text-xs text-phase-active">
          ...
          <p className="font-sans text-xs leading-relaxed text-ink-2">
            ...
            <a className="text-phase-active hover:text-phase-active underline decoration-phase-active/40"
        ...
        <p className="font-sans text-xs leading-relaxed text-ink-2 max-w-3xl">
      ...
      {/* ── How it works ── */}
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        <h2 className="font-mono text-xl text-ink-0 mb-6">How a job settles</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {LOOP.map((s) => (
            <div key={s.step} className="rounded-xl border border-line-base bg-surface-1 p-5 flex gap-4">
              <span className="font-mono text-phase-active text-sm pt-0.5">{s.step}</span>
              <div>
                <h3 className="font-mono text-sm text-ink-0 mb-1">{s.title}</h3>
                <p className="font-sans text-sm leading-relaxed text-ink-1">{s.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="rounded-xl border border-line-base bg-surface-1 p-5">
            <Scale className="h-5 w-5 text-phase-active mb-3" />
            <h3 className="font-mono text-sm text-ink-0 mb-2">Markets move assets</h3>
            <p className="font-sans text-sm leading-relaxed text-ink-1">
              Liquidity, trading and routing are market rails — on Supra, that is SupraFX&apos;s
              domain. COSMO does not compete there.
            </p>
          </div>
          <div className="rounded-xl border border-phase-active/30 bg-phase-active/[0.05] p-5">
            <PackageCheck className="h-5 w-5 text-phase-active mb-3" />
            <h3 className="font-mono text-sm text-ink-0 mb-2">COSMO settles work</h3>
            <p className="font-sans text-sm leading-relaxed text-ink-1">
          ...
          <div className="rounded-xl border border-line-base bg-surface-1 p-5">
            <Receipt className="h-5 w-5 text-phase-active mb-3" />
            <h3 className="font-mono text-sm text-ink-0 mb-2">One layer down</h3>
            <p className="font-sans text-sm leading-relaxed text-ink-1">
      ...
      <section id="guarded" className="relative z-10 max-w-5xl mx-auto px-6 py-6 scroll-mt-24">
        <div className="rounded-xl border border-phase-warn/20 bg-phase-warn/[0.04] p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-mono text-sm text-ink-0">Guarded v1 — read this before reaching out</h3>
          </div>
          <p className="font-sans text-sm leading-relaxed text-ink-1">
      ...
      <section id="pilot" className="relative z-10 max-w-5xl mx-auto px-6 py-10 pb-24">
        <div className="rounded-xl border border-phase-active/30 bg-phase-active/[0.05] p-6">
          <h2 className="font-mono text-lg text-ink-0 mb-2">Propose a small guarded compute pilot</h2>
          <p className="font-sans text-sm leading-relaxed text-ink-1 max-w-3xl mb-4">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-4 font-mono text-[11px] text-ink-2">
            <Link href="/demo/" className="text-phase-active hover:text-phase-active">
              RFQ mainnet proof →
            </Link>
            <Link href="/vault/" className="text-phase-active hover:text-phase-active">
              Maker vault →
