...
| A11 | Provider finden die Provider-Seite /market/work (neu nach Rollensplit, 2026-07-23; Discovery im Pilot nur via Outreach-Link + Querlink/Banner) | Ein Provider mit Job-Link landet auf der richtigen Seite oder folgt Banner/Querlink dorthin | Sie suchen das Angebotsformular auf der Buyer-Seite, übersehen Banner und Querlink, fragen "wo biete ich an?" |
| A12 | Buyer vermissen auf ihrer Seite nichts durch die entfernten Provider-Elemente (Rollensplit 2026-07-23) | Sie arbeiten die Buyer-Schritte ohne Nachfrage zur "fehlenden" Angebots-Abgabe ab | Sie fragen, wo man Angebote abgibt/liefert, oder halten die Seite für unvollständig |
| A13 | Der Ein-Wartezustand-Kollaps ("Provider is working" / "Buyer selects & funds") wird als "Gegenseite ist dran" verstanden | Sie benennen korrekt, dass sie warten und wer gerade handelt | Sie fragen, was in dem Schritt passiert, halten die Seite für hängend oder suchen eine eigene Aktion |
